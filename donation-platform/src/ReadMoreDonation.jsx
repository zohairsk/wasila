...
export default function ReadMoreDonation({showDetails, setShowDetails, description, weblink, title, email, phone, img1, img2, img3}) {

  return (
    <>
      <Modal size="lg" centered="true" show={showDetails} onHide={() => {setShowDetails(false)}}>
        ...
        <Modal.Body>
          {description}
          <br></br>
          <ImageCarousel img1={img1} img2={img2} img3={img3}></ImageCarousel>
          <hr></hr>
          <Row class="d-flex justify-content-center">
            ...
            <small><a href={weblink} target="_blank" >{weblink}</a></small>
            </Col>
            {phone && 
            <Col class="d-flex justify-content-center">
